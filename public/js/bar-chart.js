	...
	$.fn.skillset = function( options ) {
		...
		function create_trigger(element){
			...
			for(var i = 0; i < count; i++){
				...
				var html = '<li class="skill-'+(i+1)+'""><span>'+settings.object[i]['headline']+/*' <span class="icon-info-circled" data-info="'+settings.object[i]['description']+'"></span>*/'</span><span style="float:right">'+settings.object[i]['value']+'%</span><div class="bar"></div></li>';
